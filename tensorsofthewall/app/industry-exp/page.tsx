    ...
    return (
        <div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center'}} className="font-['arial']">
                <strong style={{marginTop: '2rem',marginBottom: '2rem'}} className="w-[370px] sm:w-[370px] md:w-[420px] lg:w-[470px] text-medium sm:text-large md:text-xl lg:text-2xl">{pageStartText}</strong>
            </div>
            <div className="flex flex-col w-full items-center justify-center min-h-screen -translate-y-[10%]" >
