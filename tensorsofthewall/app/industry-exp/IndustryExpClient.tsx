...
const IndustryExpClient: React.FC<Props> = ({ industryExperience, pageStartText, pageSubText }) => {
    ...
    return (
        <div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center'}} className="font-['arial']">
                <strong style={{marginTop: '2rem',marginBottom: '2rem'}} className="w-[90vw] max-w-[550px] text-sm sm:text-base md:text-xl lg:text-2xl">{pageStartText}<div className="blur-sm hover:blur-none transition-all duration-300" 
...
export default IndustryExpClient;